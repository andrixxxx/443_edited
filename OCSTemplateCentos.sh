...
wget https://raw.githubusercontent.com/radzvpn/radzvpn443/master/MhuradzOCSTemplate.zip
...
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo "Copyright https://www.radzvpn.ml"  						| tee -a log-install-ocspanel.txt
echo "Made with ❤ by RadzVPN"                      	                 	| tee -a log-install-ocspanel.txt
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo ""
echo ""
cd
