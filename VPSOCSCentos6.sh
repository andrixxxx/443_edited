...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/radzvpn/radzvpn443/master/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/radzvpn/radzvpn443/master/vps.conf"
...
wget https://raw.githubusercontent.com/radzvpn/radzvpn443/master/OCSPanelCentos6.zip
